	...
	return _Utils_Tuple2(
		{
			...
			input: '',
			messages: _List_Nil,
			pdfUploadForm: {bank: 'tbank', file: $elm$core$Maybe$Nothing, fileHover: false},
			pdfUploadFormShown: false,
			safetyCushion: $elm$core$Maybe$Nothing,
			tab: $author$project$Main$MainTab,
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2($elm$core$Platform$Cmd$map, $author$project$Main$SetDatePicker, datePickerCmd),
					A2($elm$random$Random$generate, $author$project$Main$GotUUID, $TSFoster$elm_uuid$UUID$generator)
				])));
};
...
var $author$project$Main$Deposit = {$: 'Deposit'};
var $author$project$Main$GotCushion = function (a) {
	return {$: 'GotCushion', a: a};
};
var $author$project$Main$GotFile = function (a) {
	return {$: 'GotFile', a: a};
};
var $author$project$Main$GotTransaction = function (a) {
	return {$: 'GotTransaction', a: a};
};
var $author$project$Main$GotTransactionList = function (a) {
	return {$: 'GotTransactionList', a: a};
};
var $author$project$Main$ToggleEdit = function (a) {
	return {$: 'ToggleEdit', a: a};
};
...
var $author$project$Main$categoryToPresentation = function (category) {
	switch (category.$) {
		case 'Food':
			return {icon: 'Icon', name: 'food'};
		case 'Salary':
			return {icon: 'Icon', name: 'salary'};
		case 'Rent':
			return {icon: 'Icon', name: 'rent'};
		case 'Shopping':
			return {icon: 'Icon', name: 'shopping'};
		case 'Transport':
			return {icon: 'Icon', name: 'transport'};
		case 'Misc':
			return {icon: 'Icon', name: 'misc'};
		default:
			var name = category.a;
			return {icon: 'Icon', name: name};
	}
};
var $author$project$Main$SafetyCushion = F2(
	function (lastBalance, avgPayment) {
		return {avgPayment: avgPayment, lastBalance: lastBalance};
	});
var $elm$json$Json$Decode$float = _Json_decodeFloat;
var $elm$json$Json$Decode$index = _Json_decodeIndex;
var $author$project$Main$decodeCushion = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$SafetyCushion,
	A2($elm$json$Json$Decode$index, 0, $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$index, 1, $elm$json$Json$Decode$float));
var $author$project$Main$Transaction = F7(
	function (id, date, category, amount, trType, expediency, editCategory) {
		return {amount: amount, category: category, date: date, editCategory: editCategory, expediency: expediency, id: id, trType: trType};
	});
...
var $author$project$Main$decodeAmount = A2(
	$elm$json$Json$Decode$andThen,
	function (_float) {
		return (!(!_float)) ? $elm$json$Json$Decode$succeed(_float) : A2(
			$elm$json$Json$Decode$andThen,
			function (string) {
			...
			A2($elm$json$Json$Decode$field, 'deposit', $elm$json$Json$Decode$string));
	},
	A2(
		$elm$json$Json$Decode$andThen,
		function (string) {
...
var $author$project$Main$Rent = {$: 'Rent'};
var $author$project$Main$Salary = {$: 'Salary'};
var $author$project$Main$Shopping = {$: 'Shopping'};
var $author$project$Main$Transport = {$: 'Transport'};
var $author$project$Main$stringToCategory = function (string) {
	switch (string) {
		case 'food':
			return $author$project$Main$Food;
		case 'salary':
			return $author$project$Main$Salary;
		case 'rent':
			return $author$project$Main$Rent;
		case 'shopping':
...
var $author$project$Main$decodeCategory = A2(
	$elm$json$Json$Decode$andThen,
	function (str) {
		return $elm$json$Json$Decode$succeed(
			$author$project$Main$stringToCategory(
...
var $author$project$Main$decodeDate = A2(
	$elm$json$Json$Decode$andThen,
	function (str) {
		return $elm$json$Json$Decode$succeed(
			A2(
				$elm$core$Maybe$withDefault,
				A3($justinmimbs$date$Date$fromCalendarDate, 2024, $elm$time$Time$Jan, 1),
				A2(
...
var $author$project$Main$decodeTrType = A2(
	...
	A2(
		$elm$json$Json$Decode$andThen,
		function (_float) {
			return $elm$json$Json$Decode$succeed(!_float);
		},
		A2(
			$elm$json$Json$Decode$andThen,
			function (string) {
...
var $author$project$Main$decodeTransaction = A8(
	$elm$json$Json$Decode$map7,
	$author$project$Main$Transaction,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'entry_date', $author$project$Main$decodeDate),
	A2(
		$elm$json$Json$Decode$field,
		'category',
		$elm$json$Json$Decode$nullable($author$project$Main$decodeCategory)),
	$author$project$Main$decodeAmount,
	$author$project$Main$decodeTrType,
	$elm$json$Json$Decode$maybe(
		A2($elm$json$Json$Decode$field, 'expediency', $elm$json$Json$Decode$int)),
...
var $author$project$Main$encodeAmount = function (transaction) {
	...
	if (_v0.$ === 'Deposit') {
		return _List_fromArray(
			[
				_Utils_Tuple2(
				'deposit',
				$elm$json$Json$Encode$float(transaction.amount)),
				_Utils_Tuple2(
				'withdraw',
...
var $author$project$Main$encodeTransaction = F3(
	function (transaction, userId, balance) {
		var category = $author$project$Main$categoryToPresentation(
			A2($elm$core$Maybe$withDefault, $author$project$Main$Misc, transaction.category));
				...
				_List_fromArray(
					[
						...
						$elm$json$Json$Encode$string(
							$justinmimbs$date$Date$toIsoString(transaction.date))),
						_Utils_Tuple2(
						'receipt_date',
						$elm$json$Json$Encode$string(
							$justinmimbs$date$Date$toIsoString(transaction.date))),
						...
						'category',
						$elm$json$Json$Encode$string(
							$author$project$Main$capitalize(category.name))),
						_Utils_Tuple2(
						'balance',
						$elm$json$Json$Encode$float(
							A2($elm$core$Maybe$withDefault, 0, balance)))
					]),
				$author$project$Main$encodeAmount(transaction)));
	});
...
var $author$project$Main$GotPollTransaction = function (a) {
	return {$: 'GotPollTransaction', a: a};
};
...
var $author$project$Main$sendTransactionPoll = function (transaction) {
	return A2(
		$elm$core$Task$attempt,
		$author$project$Main$GotPollTransaction,
		A2(
			$elm$core$Task$andThen,
			function (_v0) {
...
var $author$project$Main$GotPollTransactionList = function (a) {
	return {$: 'GotPollTransactionList', a: a};
};
var $author$project$Main$sendTransactionsPoll = function (model) {
	return A2(
		$elm$core$Task$attempt,
		$author$project$Main$GotPollTransactionList,
		A2(
			$elm$core$Task$andThen,
			function (_v0) {
				return $elm$http$Http$task(
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'UpdateAmount':
				var newInput = msg.a;
				var transactionUploadForm = model.transactionUploadForm;
				var newAmount = function () {
					var _v1 = $elm$core$String$toFloat(newInput);
					if (_v1.$ === 'Just') {
						var _float = _v1.a;
						return $elm$core$Maybe$Just(_float);
					} else {
						return transactionUploadForm.amount;
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							transactionUploadForm: _Utils_update(
								transactionUploadForm,
								{
									amount: ($elm$core$String$length(newInput) > 0) ? newAmount : $elm$core$Maybe$Nothing
								})
						}),
			...
			case 'UpdateBalance':
				...
				var transactionUploadForm = model.transactionUploadForm;
				var newAmount = function () {
					var _v2 = $elm$core$String$toFloat(newInput);
					if (_v2.$ === 'Just') {
						var _float = _v2.a;
						return $elm$core$Maybe$Just(_float);
					} else {
						return transactionUploadForm.balance;
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							transactionUploadForm: _Utils_update(
								transactionUploadForm,
								{
									balance: ($elm$core$String$length(newInput) > 0) ? newAmount : $elm$core$Maybe$Nothing
								})
						}),
					$elm$core$Platform$Cmd$none);
			case 'ChooseTrType':
					...
					_Utils_update(
						model,
						{
							transactionUploadForm: _Utils_update(
								transactionUploadForm,
								{
									trType: $elm$core$Maybe$Just(newType)
								})
						}),
					$elm$core$Platform$Cmd$none);
			case 'SetDatePicker':
				var subMsg = msg.a;
				var transactionUploadForm = model.transactionUploadForm;
				var _v3 = A3($CurrySoftware$elm_datepicker$DatePicker$update, $CurrySoftware$elm_datepicker$DatePicker$defaultSettings, subMsg, model.datePicker);
				...
				var date = function () {
					if (dateEvent.$ === 'Picked') {
						...
						return model.transactionUploadForm.date;
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'SendTransaction':
				var newTr = {
					amount: A2($elm$core$Maybe$withDefault, 0, model.transactionUploadForm.amount),
					category: $elm$core$Maybe$Nothing,
					date: A2(
						$elm$core$Maybe$withDefault,
						A3($justinmimbs$date$Date$fromCalendarDate, 2024, $elm$time$Time$Jan, 1),
						model.transactionUploadForm.date),
					editCategory: false,
					expediency: $elm$core$Maybe$Nothing,
					id: '',
					trType: A2($elm$core$Maybe$withDefault, $author$project$Main$Deposit, model.transactionUploadForm.trType)
				};
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'PickFile':
				return _Utils_Tuple2(
					...
					A2(
						...
						_List_fromArray(
							['application/pdf']),
						$author$project$Main$GotFile));
			case 'PickerHoverEnter':
				var pdfUploadForm = model.pdfUploadForm;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							pdfUploadForm: _Utils_update(
								pdfUploadForm,
								{fileHover: true})
						}),
					$elm$core$Platform$Cmd$none);
			case 'PickerHoverLeave':
				var pdfUploadForm = model.pdfUploadForm;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'GotFile':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'SendPDF':
				var _v5 = model.pdfUploadForm.file;
				if (_v5.$ === 'Just') {
					var file = _v5.a;
					return _Utils_Tuple2(
						_Utils_update(
						...
						$elm$http$Http$post(
							{
								...
								expect: A2(
									...
									$author$project$Main$GotTransactionList,
									A2(
										$elm$json$Json$Decode$at,
										_List_fromArray(
											['results']),
			...
			case 'ToggleTransactionForm':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{pdfUploadFormShown: false, transactionUploadFormShown: !model.transactionUploadFormShown}),
					$elm$core$Platform$Cmd$none);
			case 'TogglePDFForm':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{pdfUploadFormShown: !model.pdfUploadFormShown, transactionUploadFormShown: false}),
					$elm$core$Platform$Cmd$none);
			case 'GotTransactionList':
				var res = msg.a;
				if (res.$ === 'Ok') {
					var newTr = res.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{transactions: newTr}),
						$author$project$Main$sendTransactionsPoll(model));
				} else {
					var err = res.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								error: $elm$core$Maybe$Just(
									A2($elm$core$Debug$log, 'error when getting transaction', err))
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'GotTransaction':
				...
				if (res.$ === 'Ok') {
					var newTr = res.a;
					var newTransactoins = A2($elm$core$List$cons, newTr, model.transactions);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{transactions: newTransactoins}),
						$author$project$Main$sendTransactionPoll(newTr));
				} else {
					var err = res.a;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'GotPollTransaction':
				var res = msg.a;
				if (res.$ === 'Ok') {
					var newTr = res.a;
					var _v9 = newTr.category;
					if (_v9.$ === 'Just') {
						var newTrList = A2(
							$elm$core$List$map,
							function (tr) {
								return _Utils_eq(tr.id, newTr.id) ? newTr : tr;
							},
							model.transactions);
						return _Utils_Tuple2(
							_Utils_update(
			...
			case 'GotPollTransactionList':
				...
				if (res.$ === 'Ok') {
					...
					var doSomething = A3(
						...
						false,
						newTr);
					return doSomething ? _Utils_Tuple2(
						model,
						$author$project$Main$sendTransactionsPoll(model)) : _Utils_Tuple2(
						_Utils_update(
							model,
							{transactions: newTr}),
						$elm$core$Platform$Cmd$none);
			...
			case 'GotUUID':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							userId: $TSFoster$elm_uuid$UUID$toString(uuid)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleEdit':
				...
				var newTr = A2(
					$elm$core$List$map,
					function (tr) {
						return _Utils_eq(transaction.id, tr.id) ? _Utils_update(
							tr,
							{editCategory: !tr.editCategory}) : tr;
					},
					model.transactions);
				return _Utils_Tuple2(
					_Utils_update(
				...
				var newTr = A2(
					...
					function (tr) {
						return _Utils_eq(transaction.id, tr.id) ? _Utils_update(
							transaction,
							{
								category: $elm$core$Maybe$Just(
									$author$project$Main$stringToCategory(newCat))
							}) : tr;
					},
					model.transactions);
				return _Utils_Tuple2(
			...
			case 'SendCategory':
				var transaction = msg.a;
				var maybeCategory = A2($elm$core$Maybe$map, $author$project$Main$categoryToPresentation, transaction.category);
				if (maybeCategory.$ === 'Just') {
				...
				if (res.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								safetyCushion: $elm$core$Maybe$Just(cushion)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var err = res.a;
...
var $author$project$Main$GraphicsTab = {$: 'GraphicsTab'};
...
var $author$project$Main$composeTabColors = F2(
	function (model, tab) {
		return _Utils_eq(model.tab, tab) ? _List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color(
				A3($mdgriffith$elm_ui$Element$rgb255, 255, 182, 109)),
...
var $author$project$Main$countCushion = function (cushion) {
	return cushion.lastBalance - cushion.avgPayment;
};
...
var $author$project$Main$graphicsTabView = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						function () {
						var _v0 = model.safetyCushion;
						if (_v0.$ === 'Just') {
							var safetyCushion = _v0.a;
							return A2(
								$mdgriffith$elm_ui$Element$column,
								_List_fromArray(
									[
...
var $author$project$Main$TogglePDFForm = {$: 'TogglePDFForm'};
var $author$project$Main$ToggleTransactionForm = {$: 'ToggleTransactionForm'};
...
var $author$project$Main$PickerHoverEnter = {$: 'PickerHoverEnter'};
var $author$project$Main$PickerHoverLeave = {$: 'PickerHoverLeave'};
var $author$project$Main$SendPDF = {$: 'SendPDF'};
...
var $author$project$Main$dropDecoder = A2(
	...
	_List_fromArray(
		['dataTransfer', 'file']),
	A2($elm$json$Json$Decode$map, $author$project$Main$GotFile, $elm$file$File$decoder));
...
var $author$project$Main$pdfUploadFormView = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				...
				[
					...
					_List_fromArray(
						[
							...
							'dragenter',
							$elm$json$Json$Decode$succeed($author$project$Main$PickerHoverEnter)),
							A2(
							$author$project$Main$hijackOn,
							'dragover',
							$elm$json$Json$Decode$succeed($author$project$Main$PickerHoverEnter)),
							...
							$author$project$Main$hijackOn,
							'dragleave',
							$elm$json$Json$Decode$succeed($author$project$Main$PickerHoverLeave)),
							A2(
							$author$project$Main$hijackOn,
							'mouseover',
							$elm$json$Json$Decode$succeed($author$project$Main$PickerHoverEnter)),
					...
					A2(
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$Background$color(
								(!model.pdfUploadForm.fileHover) ? A3($mdgriffith$elm_ui$Element$rgb255, 250, 250, 250) : A3($mdgriffith$elm_ui$Element$rgb255, 240, 240, 240)),
							...
							label: A2(
								...
								_List_fromArray(
									[
										...
										function () {
											var _v0 = model.pdfUploadForm.file;
											if (_v0.$ === 'Nothing') {
												return $mdgriffith$elm_ui$Element$text('Icon');
											} else {
												var file = _v0.a;
										...
										$mdgriffith$elm_ui$Element$text('Upload file'))
									])),
							onPress: $elm$core$Maybe$Just($author$project$Main$PickFile)
						})),
					A2(
					$mdgriffith$elm_ui$Element$Input$button,
					_List_fromArray(
						...
						]),
					{
						...
						onPress: $elm$core$Maybe$Just($author$project$Main$SendPDF)
					})
				])));
};
var $author$project$Main$ChooseTrType = function (a) {
	return {$: 'ChooseTrType', a: a};
};
var $author$project$Main$SendTransaction = {$: 'SendTransaction'};
var $author$project$Main$UpdateAmount = function (a) {
	return {$: 'UpdateAmount', a: a};
};
var $author$project$Main$UpdateBalance = function (a) {
	return {$: 'UpdateBalance', a: a};
};
...
var $author$project$Main$transactionUploadFormView = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		A2(
			...
			_List_fromArray(
				[
					...
					A2(
						...
						_List_fromArray(
							[
								...
								A3($CurrySoftware$elm_datepicker$DatePicker$view, model.transactionUploadForm.date, $CurrySoftware$elm_datepicker$DatePicker$defaultSettings, model.datePicker))
							]))),
					A2(
					...
					{
						label: $mdgriffith$elm_ui$Element$Input$labelHidden('Amount'),
						onChange: $author$project$Main$UpdateAmount,
						...
						text: function () {
							var _v0 = model.transactionUploadForm.amount;
							if (_v0.$ === 'Just') {
								var amount = _v0.a;
								return $elm$core$String$fromFloat(amount);
							} else {
								return '';
							}
						}()
					...
					{
						label: $mdgriffith$elm_ui$Element$Input$labelHidden('Transaction type'),
						onChange: $author$project$Main$ChooseTrType,
						options: _List_fromArray(
							[
								A2(
								$mdgriffith$elm_ui$Element$Input$option,
								$author$project$Main$Deposit,
								$mdgriffith$elm_ui$Element$text('Deposit')),
								A2(
								$mdgriffith$elm_ui$Element$Input$option,
								$author$project$Main$Withdrawal,
						...
						]),
					{
						...
						onPress: $elm$core$Maybe$Just($author$project$Main$SendTransaction)
					})
				])));
};
var $author$project$Main$SendCategory = function (a) {
	return {$: 'SendCategory', a: a};
};
var $author$project$Main$UpdateCategory = F2(
	function (a, b) {
		return {$: 'UpdateCategory', a: a, b: b};
	});
...
var $author$project$Main$drawCategory = function (category) {
	if (category.$ === 'Just') {
		var cat = category.a;
		var catPresentation = $author$project$Main$categoryToPresentation(cat);
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$class('skeleton'))
				]),
			$mdgriffith$elm_ui$Element$none);
	}
};
var $elm$svg$Svg$Attributes$fill = _VirtualDom_attribute('fill');
var $author$project$Main$getExpediencyColor = function (transaction) {
	var _v0 = transaction.expediency;
	_v0$4:
	while (true) {
		if (_v0.$ === 'Just') {
			switch (_v0.a) {
...
var $author$project$Main$onEvent = F2(
	function (key, msg) {
		return $mdgriffith$elm_ui$Element$htmlAttribute(
			A2(
				$elm$html$Html$Events$on,
				...
				A2(
					$elm$json$Json$Decode$andThen,
					function (ikey) {
						return _Utils_eq(ikey, key) ? $elm$json$Json$Decode$succeed(msg) : $elm$json$Json$Decode$fail('Not the enter key');
					},
					A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string))));
	});
...
var $author$project$Main$transactionView = F2(
	function (model, transaction) {
		return A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
													...
													[
														...
														_List_fromArray(
															[
																...
																$author$project$Main$getExpediencyColor(transaction))
															]),
														_List_Nil)
													]))
											]))),
					...
					{
						label: $author$project$Main$drawCategory(transaction.category),
						...
						]),
					{
						...
						onChange: $author$project$Main$UpdateCategory(transaction),
						placeholder: $elm$core$Maybe$Nothing,
						text: function () {
							var pres = $author$project$Main$categoryToPresentation(
								A2($elm$core$Maybe$withDefault, $author$project$Main$Misc, transaction.category));
							return pres.name;
						}()
					})
...
var $author$project$Main$mainTabView = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
					...
					_List_fromArray(
						[
							...
							A2(
								...
								{
									label: $mdgriffith$elm_ui$Element$text('Add transaction'),
									onPress: $elm$core$Maybe$Just($author$project$Main$ToggleTransactionForm)
								})),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
							...
							A2(
								...
								{
									label: $mdgriffith$elm_ui$Element$text('Upload statement'),
									onPress: $elm$core$Maybe$Just($author$project$Main$TogglePDFForm)
								}))
						])))
			]),
		A2(
			$elm$core$List$map,
			$author$project$Main$transactionView(model),
			model.transactions));
};
					...
					_List_fromArray(
						[
							...
							_Utils_ap(
								...
								A2($author$project$Main$composeTabColors, model, $author$project$Main$MainTab)),
							{
								label: $mdgriffith$elm_ui$Element$text('Upload statement'),
								onPress: $elm$core$Maybe$Just(
									$author$project$Main$ChangeTab($author$project$Main$MainTab))
							}),
							A2(
							$mdgriffith$elm_ui$Element$Input$button,
							_Utils_ap(
								...
								A2($author$project$Main$composeTabColors, model, $author$project$Main$GraphicsTab)),
							{
								label: $mdgriffith$elm_ui$Element$text('Upload statement'),
								onPress: $elm$core$Maybe$Just(
									$author$project$Main$ChangeTab($author$project$Main$GraphicsTab))
							})
						])),
					function () {
					var _v0 = model.tab;
					if (_v0.$ === 'MainTab') {
						return $author$project$Main$mainTabView(model);
					} else {
						return $author$project$Main$graphicsTabView(model);
					}
				}()
				])));
};
